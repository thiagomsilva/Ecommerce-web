...
const List: React.FC = () => {
  ...
  // estado para armazenar o id da categoria para remoção, ao clicar no ícone para remover uma categoria, esse estado é atualizado
  const [categoryToRemove, setCategoryToRemove] = useState(0);
  // estado utilizado para forçar a revalidação de cache do SWR, toda vez que o mesmo mudar o SWR irá realizar uma revalidação de cache
